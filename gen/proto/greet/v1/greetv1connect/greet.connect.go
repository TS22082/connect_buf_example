...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/TS22082/connect_buf_example/gen/proto/greet/v1"
	http "net/http"
	strings "strings"
)
...
func NewGreetServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GreetServiceClient {
	...
	greetServiceMethods := v1.File_proto_greet_v1_greet_proto.Services().ByName("GreetService").Methods()
